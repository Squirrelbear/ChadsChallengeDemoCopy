...
namespace GameDevMajor.Blocks
{
    ...
    {
        public RedBlock(Vector2 position, Direction facing, Level lvl)
            : base(position, lvl.getSprite(GameObject.Type.Block, (int)BlockType.Red), new ArrayList(), facing, BlockType.Red, lvl)
        {
