...
namespace GameDevMajor.Blocks
{
    ...
    {
        public GreenBlock(Vector2 position, Direction facing, Level lvl)
            : base(position, lvl.getSprite(GameObject.Type.Block, (int)BlockType.Green), new ArrayList(), facing, BlockType.Green, lvl)
        {
