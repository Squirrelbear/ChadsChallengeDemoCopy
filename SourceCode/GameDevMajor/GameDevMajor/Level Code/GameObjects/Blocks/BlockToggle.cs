...
namespace GameDevMajor.Blocks
{
    ...
    {
        public BlockToggle(Vector2 position, Direction facing, Level lvl)
            : base(position, lvl.getSprite(GameObject.Type.Block, (int)BlockType.Toggle), new ArrayList(), facing, BlockType.Toggle, lvl)
        {
