...
namespace GameDevMajor.Blocks
{
    ...
    {
        public InvisibleBlock(Vector2 position, Direction facing, Level lvl)
            : base(position, lvl.getSprite(GameObject.Type.Block, (int)BlockType.Invisible), new ArrayList(), facing, BlockType.Invisible, lvl)
        {
