...
namespace GameDevMajor.Monsters
{
    class IceMonster : Monster
    {
        ...
        public IceMonster(Vector2 pos, Direction facing, Level lvl)
            : base(pos, lvl.getSprite(Type.Monster, (int)MonsterType.Ice), new ArrayList(), facing, MonsterType.Ice, lvl)
        {
